...
2. Crie um container do Postgres:
  ```bash
  docker run --name dev-database -e POSTGRES_PASSWORD=password_postgres -e POSTGRES_USER=user_postgres -d -p 5432:5432 postgres
  ```

3. Criar arquivo .env de acordo com o arquivo .env.example que está na pasta "back-end/"
...
6. Acesse [http://localhost:3000/docs](http://localhost:3000/docs) com o seu navegador para ver o resultado.
